...
pub const ENEMY_ANGLE_SPEED_RANGE: Vec2 = Vec2::from_array([0.2f32, 3f32]);

pub const ENEMY_SPEED_HOMING: Vec2 = Vec2::from_array([60f32, 30f32]);
...
pub const ENEMY_MINI_HOMING_TIME_RANGE: Vec2 = Vec2::from_array([4f32, 10f32]);
